...
const Hero: React.FC = () => {
  return (
    <div className="bg-accent-dark h-132 bg-[url('/img/hero.webp')] bg-cover">
      <div className="container py-16 px-8 text-white xl:p-24">
        <span className="rounded-full bg-gradient-to-b from-cyan-500 to-blue-500 py-1 px-4 text-sm">
          ПОДКАСТ
        </span>
        <h1 className="mt-2 text-6xl selection:bg-fuchsia-300 selection:text-fuchsia-900">
          Давай отпиарю
        </h1>
        ...
        <p className="mt-6 text-lg selection:bg-fuchsia-300 selection:text-fuchsia-900 lg:w-2/3 xl:w-1/2">
